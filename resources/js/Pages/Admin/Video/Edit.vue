...
function submit() {
    form.post(route('admin.videos.update', props.video.id), {headers: {'Content-Type': 'multipart/form-data'}});
}
...
<template>
    ...
    <form @submit.prevent="submit" class="w-1/2 mx-auto my-5">
        <div class="mb-5">
            <Link :href="route('admin.videos.index')" class="font-bold text-gray-900">
                &larr; Back
            </Link>
        </div>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2 flex gap-2">
                            <p v-for="urlItem in props.video.img_url">
                                <img :src="urlItem" :alt="props.video.title" width="200">
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg
                            cursor-pointer focus:outline-none" id="images" type="file" multiple @change="setImages">
                    </div>
